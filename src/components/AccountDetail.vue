  ...
  <div>
    ...
    <div v-show="showCard">
      <div class="row justify-center q-my-md">
        <q-card class="q-pa-none position-relative" bordered flat>
          ...
          <div class="foreground-content q-pa-md">
            <div class="row items-start">
              ...
              <div class="col">
                <div class="text-h5 q-ml-lg q-my-lg account-name">
            ...
            <tbody>
              <tr v-for="item in displayFields" :key="item.text">
                ...
                <td class="wrap-cell text-right">
                  <router-link
                    ...
                    :to="
                      item.link.path.replace(
                        '{value}',
                        encodeURIComponent(
                          item.property === 'im_user_id' ? datum[item.property] : datum.id,
                        ),
                      )
                    "
                  >
                  ...
                  <a v-else-if="item.a" :href="datum[item.property]" target="_blank" rel="noopener">
                    {{ datum[item.property] }}
                  </a>
...
.profile-picture-link {
  border: 1px solid $white-semiopaque;
  border-radius: 6px;
  overflow: hidden;
}
